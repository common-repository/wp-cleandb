...
function Clean_Post_Revisions() {
	...
	return __('Post revisions cleaned up!<br />', 'wp-cleandb');
...
<div class="wrap">
	...
	<h3><?php _e('At a glance', 'wp-cleandb'); ?></h3>
	...
	<h3><?php _e('Total report', 'wp-cleandb'); ?></h3>
	...
	<form action="#" method="post" id="cleanup-form">
		...
		<table class="widefat">
			...
			<thead>
			 ...
			 <th width="5%"><?php _e('Cleanup?', 'wp-cleandb'); ?></th>

			 <th width="50%"><?php _e('Description', 'wp-cleandb'); ?></th>

			 <th width="15%"><?php _e('Amount', 'wp-cleandb'); ?></th>

			 <th width="15%"><?php _e('Size', 'wp-cleandb'); ?></th>

			 <th width="15%"><?php _e('Percentage of Total', 'wp-cleandb'); ?></th>
			...
			<tr>
				...
				<td><?php _e('Database Size', 'wp-cleandb'); ?></td>
			...
			<tr>
				...
				<td><?php _e('Useful WordPress Data', 'wp-cleandb'); ?></td>
			...
			<tr>
				...
				<td><?php _e('Post Revisions', 'wp-cleandb'); ?></td>
			...
			<tr>
				...
				<td><?php _e('Spam Comments', 'wp-cleandb'); ?></td>
			...
			<tr>
				...
				<td><?php _e('Unapproved Comments', 'wp-cleandb'); ?></td>
			...
			<tr>
				...
				<td><?php _e('Unused Tags', 'wp-cleandb'); ?></td>
			...
			<tr>
				...
				<td><?php _e('Unused Post Meta', 'wp-cleandb'); ?></td>
			...
			<tr>
				...
				<td><?php _e('Unused MySQL Data', 'wp-cleandb'); ?></td>
		...
		<p><?php _e('Make sure you have a backup of your WordPress database before cleanup!', 'wp-cleandb'); ?></p>

		<p>

			<input type="submit" name="submit" value="<?php _e('Cleanup the selected items!', 'wp-cleandb'); ?>" style="width: 300px;" class="button-primary">
